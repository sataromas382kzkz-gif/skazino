...
// Вероятности для коэффициентов: 0.2x — 15%, 0.5x — 20%, 1.0x — 15%,
// 1.2x — 25%, 1.5x — 22%, 5.0x — 3%.
// Боковые слоты симметричны, поэтому вероятность делится между двумя сторонами.
// Сумма всех 11 слотов ровно 100%.
const PLINKO_PROBABILITIES = [0.075, 0.10, 0.075, 0.125, 0.11, 0.03, 0.11, 0.125, 0.075, 0.10, 0.075];
