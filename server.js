...
// Вероятности для коэффициентов: 0.2x — 20%, 0.5x — 20%, 1.0x — 18%,
// 1.2x — 22%, 1.5x — 17%, 5.0x — 3%.
// Боковые слоты симметричны, поэтому вероятность делится между двумя сторонами.
// Сумма всех 11 слотов ровно 100%.
const PLINKO_PROBABILITIES = [0.10, 0.10, 0.09, 0.11, 0.085, 0.03, 0.085, 0.11, 0.09, 0.10, 0.10];
