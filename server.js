...
// Треугольное поле с 12 рядами имеет 13 конечных слотов. Коэффициенты
// симметричны: центральная ячейка самая выгодная, к краям значения снижаются.
const PLINKO_PAYOUTS = {
  low:    [0.2, 0.3, 0.5, 0.7, 1.0, 1.5, 4.0, 1.5, 1.0, 0.7, 0.5, 0.3, 0.2],
  medium: [0.1, 0.2, 0.4, 0.6, 0.9, 1.5, 6.0, 1.5, 0.9, 0.6, 0.4, 0.2, 0.1],
  high:   [0.1, 0.2, 0.3, 0.5, 0.8, 1.5, 12.0, 1.5, 0.8, 0.5, 0.3, 0.2, 0.1]
};
const PLINKO_MIN_BET = 10;
// Вероятность центральных слотов немного увеличена: крупный коэффициент
// по-прежнему остаётся редким, но выпадает заметно чаще.
const PLINKO_PROBABILITIES = [0.015, 0.025, 0.04, 0.07, 0.11, 0.18, 0.28, 0.12, 0.06, 0.035, 0.025, 0.02, 0.02];
