...
// Треугольное поле с 8 рядами начинается с 3 точек и заканчивается 10 точками,
// поэтому содержит 11 конечных слотов. Коэффициенты симметричны: крупные
// значения находятся ближе к центру, крайние слоты дают 0.3x, максимум — 5x.
const PLINKO_PAYOUTS = {
  // 11 слотов: крайние значения 0.2x, центральный максимум 5x.
  // Для каждого уровня сохраняем симметрию поля.
  low:    [0.2, 0.5, 1.0, 1.2, 1.5, 5.0, 1.5, 1.2, 1.0, 0.5, 0.2],
  medium: [0.2, 0.5, 1.0, 1.5, 2.0, 5.0, 2.0, 1.5, 1.0, 0.5, 0.2],
  high:   [0.2, 0.5, 1.2, 1.5, 2.0, 5.0, 2.0, 1.5, 1.2, 0.5, 0.2]
};
