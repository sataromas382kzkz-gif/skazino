...
const PLINKO_PAYOUTS = {
  low:    [0.2, 0.25, 0.3, 0.4, 0.5, 0.7, 1.0, 1.5, 4.0, 1.5, 1.0, 0.7, 0.5, 0.3, 0.2],
  medium: [0.1, 0.15, 0.2, 0.3, 0.4, 0.6, 0.9, 1.5, 6.0, 1.5, 0.9, 0.6, 0.4, 0.2, 0.1],
  high:   [0.1, 0.15, 0.2, 0.25, 0.3, 0.5, 0.8, 1.5, 12.0, 1.5, 0.8, 0.5, 0.3, 0.2, 0.1]
};
...
const PLINKO_PROBABILITIES = [0.01, 0.015, 0.025, 0.04, 0.06, 0.09, 0.14, 0.20, 0.25, 0.09, 0.04, 0.02, 0.01, 0.005, 0.005];
