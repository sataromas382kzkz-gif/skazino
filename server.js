...
// Вероятности смещены к небольшим коэффициентам. Сумма ровно 1.
// 5x остаётся редким центральным выигрышем (4%).
const PLINKO_PROBABILITIES = [0.04, 0.08, 0.12, 0.14, 0.11, 0.02, 0.11, 0.14, 0.12, 0.08, 0.04];
