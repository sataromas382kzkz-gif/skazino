...
// Вероятности для коэффициентов: 0.2x — 24%, 0.5x — 22%, 1.0x — 16%,
// 1.2x — 22%, 1.5x — 15%, 5.0x — 1%.
// Боковые слоты симметричны, поэтому вероятность делится между двумя сторонами.
// Сумма всех 11 слотов ровно 100%.
const PLINKO_PROBABILITIES = [0.12, 0.11, 0.08, 0.11, 0.075, 0.01, 0.075, 0.11, 0.08, 0.11, 0.12];
